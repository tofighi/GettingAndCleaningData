...
This code book describes the variables, the data, and any preprocessing for getting and cleaning  the data.
...
3. This script will automatically set working directory to your optional directory, download and install required dependencies (```reshapre2``` and ```data.table``` librareis) automatically. It also download dataset zip file into the same directory. 
